...
First we have to grab the data! To do this we use the `get_pdxTrees_parks` and `get_pdxTrees_streets` functions. For theses examples we are only going to look at the park data. 
...
pdxTrees_parks %>%   
  ...
  labs( x = "Inventory Date", 
        y = "Count", 
        title= "When was pdxTrees Parks Inventoried?") + 
  # adding a theme 
  theme_minimal() + 
